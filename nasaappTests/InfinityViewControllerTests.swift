...
class InfinityViewControllerTests: XCTestCase {
    
    var viewControllerUnderTest: InfinityScrollViewController!
    ...
    override func setUp() {
        ...
        self.viewControllerUnderTest = InfinityScrollViewController(viewModel: viewModel)
